...
Support teams deal with a large number of tickets every day, and going through all of them by hand to spot patterns 

or problem areas takes a lot of time. This project builds a small Python program that stores ticket data, cleans up 

the free-text issue descriptions, and pulls out a few useful insights - things like how many tickets are high priority, 
